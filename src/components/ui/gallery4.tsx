...
// Portfolio items — first draft from the real systems. Swap images for real screenshots.
const data: Gallery4Item[] = [
  ...
  },
  {
    ...
    description:
      "A product-scoped AI assistant across five surfaces, including a conversational form editor where clients change fields, branding and prices by chatting — with money-affecting edits confirmation-gated.",
    href: "#",
    image:
...
const Gallery4 = ({
  ...
  description = "A solo-built body of work — from a production B2B SaaS to a multi-agent AI orchestration framework. Each system below maps to a real, named market category.",
  items = data,
}: Gallery4Props) => {
